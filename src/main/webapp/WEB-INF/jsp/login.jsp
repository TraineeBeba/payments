	...
	<main class="px-3">
		<div class="form-container">
			...
			<form style="padding: 2%" action="<n:Name value="controller.name"/>" method="post">
				...
				<input type="hidden" name="command" value="<n:Name value="command.login"/>">
			...
			<a class="nav-link active"  href="/<n:Name value="controller.name"/><n:Name value="redirect.register"/>"> <my:Locale value="page.login.go_register"/></a>
		</div>
	</main>
</div>
</body>
